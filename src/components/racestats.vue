  ...
  computed: {
    ...
    carName: function() {
      const carMap = {
        ...
        '3072': '2018 Porsche 911 GT3 RS'
      };

      return carMap[this.carOrdinal];
    },
    displayedCarClass: function() {
      const classMap = {
        '0': 'D',
        '1': 'E',
        '2': 'B',
      ...
      return classMap[this.carClass]
    },
    displayedDrivetrain: function() {
      const drivetrainMap = {
        '0': 'FWD',
        '1': 'RWD',
        '2': 'AWD'
      ...
      return drivetrainMap[this.drivetrainType];
    }
  }
};
</script>
